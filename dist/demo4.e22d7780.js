...
exports.preloadFonts = exports.preloadImages = exports.getMousePos = exports.randomNumber = exports.clamp = exports.lerp = exports.map = void 0;
...
},{}],"ZH4r":[function(require,module,exports) {
"use strict";
...
lscroll.on('scroll', function (obj) {
  for (var _i = 0, _Object$keys = Object.keys(obj.currentElements); _i < _Object$keys.length; _i++) {
    ...
    if (obj.currentElements[key].el.classList.contains('gallery__item')) {
      var progress = obj.currentElements[key].progress; //const scaleVal = progress < 0.5 ? clamp(map(progress,0,0.5,1.2,0.5),0.5,1.2) : clamp(map(progress,0.5,1,0.5,1.2),0.5,1.2);
...
},{"../utils":"MgTz","../cursor":"LMRJ","locomotive-scroll":"ez7q"}]},{},["ZH4r"], null)